...
```bash
curl -fsSL https://raw.githubusercontent.com/Anmol-06/Devaster---Device-Master/main/install_unix.sh | bash
```
...
git clone https://github.com/Anmol-06/Devaster---Device-Master.git
